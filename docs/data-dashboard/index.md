...
Role này là **Front-End thuần, chuyên dashboard giám sát hạ tầng viễn thông** (CPE, Wi-Fi, network, QoE). Đọc kỹ JD, có đúng **3 trụ cột kỹ thuật** mà bạn gần như chắc chắn bị hỏi đào sâu:
...
| Xử lý dữ liệu lớn (data-heavy, analytics UI) | "Dataset 1 triệu dòng — làm sao không giật? Downsample thế nào?" | [02 — Large Datasets](./02-large-datasets.md) |
...
2. **Đọc 3 file này** để có đạn dược trả lời follow-up kỹ thuật.
